...
export default function HouseDialogue({isOpen, onClose}){
            ...
            >
              ...
              >
                ...
                <div className="flex flex-col items-start gap-3 pb-10">
                    ...
                    <h3>People capacity: <span>10</span></h3>
                    <h3>Working people: <span>7</span></h3>
                    <h3>Meat consumption: <span>7 per minute</span></h3>
                </div>
                ...
                <div className="pb-4">
                    <h3>Next Upgrade: <span>Capacity 15</span></h3>
                </div>
